...
namespace eSignature.Examples
{
    public static class SigningViaEmail
    {
        ...
        private static EnvelopeDefinition MakeEnvelope(string signerEmail, string signerName, string ccEmail, string ccName, string docDocx, string docPdf, string envStatus)
        {
            ...
            env.EmailSubject = "Assine este conjunto de documentos";
            ...
            Document doc3 = new Document
            {
                ...
                Name = "Autorização de Faturamento ", // can be different from actual file name
                FileExtension = "pdf",
                DocumentId = "3"
            };
        ...
        public static EnvelopeDocumentsResult GetListDocumentEnvelope(string accessToken, string basePath, string accountId, string envelopeId)
        {
        ...
        public static Stream GetListDocument(string accessToken, string basePath, string accountId, string envelopeId, string documentId)
        {
            ApiClient apiClient = new ApiClient(basePath);
            apiClient.Configuration.DefaultHeader.Add("Authorization", "Bearer " + accessToken);
            var envelopesApi = new EnvelopesApi(apiClient);
            Stream results = envelopesApi.GetDocument(accountId,
                envelopeId, "combined");
        ...
        public static EnvelopesInformation GetListEnvelopeDate(string accessToken, string basePath, string accountId, int dias)
        {
            // Data for this method
            // accessToken
            // basePath
            ...
            options.fromDate = DateTime.Now.AddDays(- +dias).ToString("yyyy/MM/dd");
            // Call the API method:
            EnvelopesInformation results = envelopesApi.ListStatusChanges(accountId, options);
            return results;
        }

        public static EnvelopesInformation GetListEnvelopeId(string accessToken, string basePath, string accountId, string idEnvelope)
        {
            // Data for this method
            // accessToken
            // basePath
            ...
            var envelopesApi = new EnvelopesApi(apiClient);
            ListStatusChangesOptions options = new ListStatusChangesOptions();
            options.envelopeIds = idEnvelope;
            // Call the API method:
            EnvelopesInformation results = envelopesApi.ListStatusChanges(accountId, options);
            return results;
        }

        public static EnvelopesInformation GetListEnvelopeStatus(string accessToken, string basePath, string accountId, string status)
        {
            // Data for this method
            // accessToken
            // basePath
        ...
        public static EnvelopesInformation GetListEnvelopIdUser(string accessToken, string basePath, string accountId, string idUser)
        {
            // Data for this method
            // accessToken
            // basePath
